        ...
        resources: {
            ...
            en: {
                ...
                translation: {
                    ...
                    locationText: "Haus Rosenbühl is quietly situated in Fleckl, surrounded by the forests and mountains of the Fichtel Mountains. Hiking trails, ski slopes and numerous destinations are within easy reach from here.",
                    locationMapHeadline: "Find us",
                    openInGoogleMaps: "Open in Google Maps",
                    googleMapsTitle: "Location of Haus Rosenbühl on Google Maps",
                    googleMapsConsentHeadline: "Display Google Maps",
                    googleMapsConsentText: "The map is provided by Google. It is loaded only after you agree; data may then be transmitted to Google and cookies may be set.",
                    loadGoogleMaps: "Load Google Maps",
                    regionalMapHeadline: "The surrounding area at a glance",
                    regionalMapAlt: "Map of the Fichtel Mountains showing Haus Rosenbühl near Fleckl, Ochsenkopf and the surrounding towns",
                    expandRegionalMap: "Open the regional map in the zoom viewer",
                    zoomIn: "Zoom in",
                    zoomOut: "Zoom out",
                    resetZoom: "Reset",
                    closeMap: "Close map",
            ...
            de: {
                translation: {
                    ...
                    locationText: "Das Haus Rosenbühl liegt ruhig in Fleckl, umgeben von den Wäldern und Bergen des Fichtelgebirges. Wanderwege, Skipisten und zahlreiche Ausflugsziele sind von hier aus schnell erreichbar.",
                    locationMapHeadline: "So finden Sie uns",
                    openInGoogleMaps: "In Google Maps öffnen",
                    googleMapsTitle: "Lage des Haus Rosenbühl auf Google Maps",
                    googleMapsConsentHeadline: "Google Maps anzeigen",
                    googleMapsConsentText: "Die Karte wird von Google bereitgestellt. Sie wird erst nach Ihrer Zustimmung geladen; dabei können Daten an Google übermittelt und Cookies gesetzt werden.",
                    loadGoogleMaps: "Google Maps laden",
                    regionalMapHeadline: "Die Umgebung auf einen Blick",
                    regionalMapAlt: "Karte des Fichtelgebirges mit dem Haus Rosenbühl bei Fleckl, dem Ochsenkopf und den umliegenden Orten",
                    expandRegionalMap: "Umgebungskarte in der Zoomansicht öffnen",
                    zoomIn: "Vergrößern",
                    zoomOut: "Verkleinern",
